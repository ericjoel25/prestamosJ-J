...
export default function ListaDePagos(props) {
  ...
  return (
      ...
      <LinearGradient colors={['#7F7FD5', '#91EAE4']} style={styles.body}>
        <StatusBar barStyle='light-content' hidden={false} backgroundColor='#E3C868' />
...
function FormData(props) {
  ...
  const Navigation = () => {
    navigation.navigate('BuscarPagos', { id: id });
  ...
  return (
    ...
    <ScrollView >
      ...
      <LinearGradient colors={['#AC6529', '#E3C868']} key={id} style={styles.container}>
